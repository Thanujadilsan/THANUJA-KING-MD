...
const BOTNAME = 'THANUJA-KING-MD|Prabath kumara';
const FOOTERNAME = '>THANYJA-KIMG-MD';
global.owner = process.env.OWNER_NUMBER  || '94701992015' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || ' ' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94711925738,94 71 468 7267" : process.env.MODERATORS ,    
...
FOOTER: process.env.FOOTER || '‌THANUJA-KING-MD',    
